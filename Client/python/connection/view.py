...
class View(wx.BoxSizer):
    ...
    def InitUI(self):
        ...
        self.loginEntry = wx.TextCtrl(self.parent,value="",style=wx.wx.TE_LEFT|wx.TE_PROCESS_ENTER)
        self.serveurEntry = wx.TextCtrl(self.parent,value="",style=wx.wx.TE_LEFT|wx.TE_PROCESS_ENTER)
